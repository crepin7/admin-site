...
function FormulaireSalle({ onSubmit, initialData = {}, batiments, onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/30 backdrop-blur-sm animate-fade-in">
      <div className="glass p-8 rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto animate-scale-in relative">
        ...
        <form onSubmit={gererSoumission} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-white mb-1">Capacité</label>
            <input type="number" name="capacite" value={donneesFormulaire.capacite} onChange={gererChangement} className="input-modern" required />
          </div>
          <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" name="latitude" value={donneesFormulaire.latitude} onChange={gererChangement} className="input-modern" step="any" placeholder="Optionnel" />
            </div>
            <div>
              <label className="block text-sm font-medium text-white mb-1">Longitude</label>
              <input type="number" name="longitude" value={donneesFormulaire.longitude} onChange={gererChangement} className="input-modern" step="any" placeholder="Optionnel" />
            </div>
          </div>
          <div>
          ...
          <div>
            <label className="block text-sm font-medium text-white mb-1">Bâtiment</label>
            <select name="buildingId" value={donneesFormulaire.buildingId} onChange={gererChangement} className="input-modern" required>
