...
import { FaBuilding, FaTimes, FaImage, FaUpload } from "react-icons/fa";
...
function FormulaireBatiment({ onSubmit, initialData = {}, onClose }) {
  ...
  const gererUploadImage = async (e) => {
    ...
    if (fichiers.length > 0) {
      // Affichage d'un indicateur de chargement possible ici
      const urls = [];
      ...
      <div className="glass p-8 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-scale-in relative">
        ...
        <form onSubmit={gererSoumission} className="space-y-4">
          ...
          <div>
            ...
            <select name="type" value={donneesFormulaire.type} onChange={gererChangement} className="input-modern" required>
